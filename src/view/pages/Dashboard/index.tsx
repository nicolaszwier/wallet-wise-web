  ...
  return (
    <div className="w-full h-full p-2 md:p-4">
      <div className="grid gap-4 grid-cols-2 lg:grid-cols-3">
        <BalanceCard title={t('global.currentBalance')} amount={selectedPlanning?.currentBalance || 0} currency={selectedPlanning?.currency || "BRL"}/>
        <BalanceCard title={t('global.expectedBalance')} amount={selectedPlanning?.expectedBalance || 0} currency={selectedPlanning?.currency || "BRL"}/>
